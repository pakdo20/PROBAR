...
import pe.edu.upc.bodega.models.repositories.ClienteRepository;
...
public class ClienteServiceImpl  implements ClienteService,Serializable {
	...
	@Override
	public List<Cliente> findByBodegueroInteger(Integer bodegueroInteger) throws Exception {
		
		return clienteRepository.findByBodegueroIntegerIs(bodegueroInteger);
	}
